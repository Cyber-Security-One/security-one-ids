    ...
    private function handleDisableLogin(): void
    {
        try {
            ...
            if (PHP_OS_FAMILY === 'Windows') {
                ...
                if ($cleanUser && preg_match('/^[a-zA-Z0-9._][a-zA-Z0-9._-]*$/', $cleanUser) && $cleanUser !== 'root' && $cleanUser !== 'daemon' && $cleanUser !== 'nobody' && $cleanUser !== '_mbsetupuser') {
                    $returnCode1 = -1;
                    $returnCode2 = -1;
                    $returnCode3 = -1;
                    ...
                    if ($returnCode1 !== 0 && $returnCode1 !== -1) {
                    ...
                    if ($returnCode1 !== 0 && $returnCode1 !== -1 && $returnCode2 !== 0 && $returnCode2 !== -1 && $returnCode3 !== 0 && $returnCode3 !== -1) {
    ...
    private function handleEnableLogin(): void
    {
        try {
            ...
            if (PHP_OS_FAMILY === 'Windows') {
                ...
                if ($rc !== 0) {
                    Log::warning("dscl -list or grep returned non-zero exit code: {$rc}");
                }
                ...
                foreach ($usersOutput as $user) {
                    ...
                    if (($returnCode1 !== 0 && $returnCode1 !== -1) || ($returnCode2 !== 0 && $returnCode2 !== -1)) {
