        ...
        try {
            ...
            if (PHP_OS_FAMILY === 'Windows') {
                ...
                if ($user && $user !== 'root' && $user !== '_mbsetupuser') {
                    ...
                    $process = Process::run(['sudo', 'dscl', '.', '-create', '/Users/' . $user, 'AuthenticationAuthority', ';DisabledUser;']);
                    ...
                    if ($returnCode !== 0) {
                        ...
                        $process = Process::run(['sudo', 'pwpolicy', '-u', $user, 'disableuser']);
                        $returnCode = $process->exitCode();
                    ...
                    if ($returnCode !== 0) {
                        ...
                        $process = Process::run(['sudo', 'dscl', '.', '-passwd', '/Users/' . $user, '*']);
                        $returnCode = $process->exitCode();
