    ...
    private function handleDisableLogin(): void
    {
        try {
            ...
            if (PHP_OS_FAMILY === 'Windows') {
                ...
                if ($consoleUser && preg_match('/^[a-zA-Z0-9._][a-zA-Z0-9._\s-]*$/', $consoleUser) && $consoleUser !== 'root' && $consoleUser !== '_mbsetupuser') {
                    // Method 1: Use dscl to disable user account
                    // The correct way is to set AuthenticationAuthority to DisabledUser
                    $output = [];
                    exec("sudo dscl . -create /Users/" . escapeshellarg($consoleUser) . " AuthenticationAuthority ';DisabledUser;' 2>&1", $output, $returnCode);
        ...
        try {
            ...
            if (PHP_OS_FAMILY === 'Windows') {
                ...
                foreach ($usersOutput as $user) {
                    $user = trim($user);
                    if (!$user || !preg_match('/^[a-zA-Z0-9._][a-zA-Z0-9._\s-]*$/', $user)) continue;
