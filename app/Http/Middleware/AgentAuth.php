...
class AgentAuth
{
    ...
    public function handle(Request $request, Closure $next): Response
    {
        ...
        if ($agentToken === '') {
            Log::warning('AGENT_TOKEN is missing or empty. This may cause authentication failures.');
            throw new MissingAgentTokenException('Server misconfiguration: missing agent token');
        }
